...
@python.define
class UploadIQMs(python.Task["UploadIQMs.Outputs"]):
    """
    Examples
    -------
    ...
    def function(
        ...
        payload_file = str(Path("payload.json").absolute())
